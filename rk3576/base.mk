...
TARGET_SD_RAW_FILENAME=friendlywrt_24.10_$(date +%Y%m%d)_rk3576_arm64_sd.img
TARGET_EFLASHER_RAW_FILENAME=friendlywrt_24.10_$(date +%Y%m%d)_rk3576_arm64_eflasher.img
